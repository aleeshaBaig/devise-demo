...
ActiveRecord::Schema[7.0].define(version: 2022_07_18_065957) do
  ...
  create_table "electricities", force: :cascade do |t|
    ...
    t.datetime "updated_at", null: false
    t.integer "user_id"
    t.index ["user_id"], name: "index_electricities_on_user_id"
  end
  ...
  create_table "internets", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["customer_id"], name: "index_internets_on_customer_id"
  end
  ...
  create_table "suigas", force: :cascade do |t|
    t.string "company"
    t.integer "consumerId"
    t.integer "customer_id", null: false
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["customer_id"], name: "index_suigas_on_customer_id"
  end
  ...
  add_foreign_key "internets", "customers"
  add_foreign_key "suigas", "customers"
