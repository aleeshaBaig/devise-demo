...
class WatersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create water" do
    assert_difference("Water.count") do
      post waters_url, params: { water: { company: @water.company, consumerId: @water.consumerId, customer_id: @water.customer_id } }
    end
  ...
  test "should update water" do
    patch water_url(@water), params: { water: { company: @water.company, consumerId: @water.consumerId, customer_id: @water.customer_id } }
